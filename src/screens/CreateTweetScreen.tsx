    ...
    <React.Fragment>
      <View style={[styles.root, { paddingTop: insets.top }]}>
        <View style={styles.actionBar}>
          <TextButton text="キャンセル" color="#c71585" fontSize={14} onPress={navigation.goBack} />
          <FilledButton text="投稿" fontSize={14} onPress={() => onTweet(text, fileURLs)} />
        </View>
        <ScrollView>
        ...
        <View style={styles.bottomActionBarWrapper}>
          ...
          <View style={styles.bottomActionBar}>
            <TouchableOpacity onPress={onAddImage}>
              <EvilIcons name="image" size={36} color="#c71585" />
            </TouchableOpacity>
          </View>
      ...
      <LoadingModal text={"saving"} isVisible={fetching} />
    </React.Fragment>
  )
}
